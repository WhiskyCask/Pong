  ...
  57              	draw_object:
  58              	.LFB0:
  59              		.file 1 "/home/oscar/Dokument/MOP/Pong/object.c"
   1:/home/oscar/Dokument/MOP/Pong/object.c **** /*
   2:/home/oscar/Dokument/MOP/Pong/object.c ****  * 
   3:/home/oscar/Dokument/MOP/Pong/object.c ****  * 	object.c
   4:/home/oscar/Dokument/MOP/Pong/object.c ****  *
   5:/home/oscar/Dokument/MOP/Pong/object.c ****  */
   6:/home/oscar/Dokument/MOP/Pong/object.c **** 
   7:/home/oscar/Dokument/MOP/Pong/object.c **** #include "object.h"
   8:/home/oscar/Dokument/MOP/Pong/object.c **** #include "graphicdisplay.h"
   9:/home/oscar/Dokument/MOP/Pong/object.c **** 
  10:/home/oscar/Dokument/MOP/Pong/object.c **** const Geometry geometry_ball = { 12, 4, 4, {
  11:/home/oscar/Dokument/MOP/Pong/object.c **** 			{0, 1}, {0, 2}, 
  12:/home/oscar/Dokument/MOP/Pong/object.c **** 	{1, 0}, {1, 1}, {1, 2}, {1, 3},
  13:/home/oscar/Dokument/MOP/Pong/object.c **** 	{2, 0}, {2, 1}, {2, 2}, {2, 3},
  14:/home/oscar/Dokument/MOP/Pong/object.c **** 			{3, 1}, {3, 2}
  15:/home/oscar/Dokument/MOP/Pong/object.c **** 	}
  16:/home/oscar/Dokument/MOP/Pong/object.c **** };
  17:/home/oscar/Dokument/MOP/Pong/object.c **** 
  18:/home/oscar/Dokument/MOP/Pong/object.c **** 
  19:/home/oscar/Dokument/MOP/Pong/object.c **** void draw_object(Object * object)
  20:/home/oscar/Dokument/MOP/Pong/object.c **** {
  60              		.loc 1 20 0
  61              		.cfi_startproc
  ...
  74              	.LBB2:
  21:/home/oscar/Dokument/MOP/Pong/object.c **** 	for (uint8_t i = 0; i < object->geometry->num_points; i++) {
  75              		.loc 1 21 0
  ...
  80 0010 27E0     		b	.L2
  81              	.L3:
  22:/home/oscar/Dokument/MOP/Pong/object.c **** 		pixel(object->geometry->points[i].x + object->pos_x, object->geometry->points[i].y + object->pos_
 ...
 133              	.LBE2:
  23:/home/oscar/Dokument/MOP/Pong/object.c **** 	}
  24:/home/oscar/Dokument/MOP/Pong/object.c **** }
 ...
 150              	clear_object:
 151              	.LFB1:
  25:/home/oscar/Dokument/MOP/Pong/object.c **** 
  26:/home/oscar/Dokument/MOP/Pong/object.c **** void clear_object(Object * object)
  27:/home/oscar/Dokument/MOP/Pong/object.c **** {
 152              		.loc 1 27 0
 153              		.cfi_startproc
 ...
 166              	.LBB3:
  28:/home/oscar/Dokument/MOP/Pong/object.c **** 	for (uint8_t i = 0; i < object->geometry->num_points; i++) {
 167              		.loc 1 28 0
 ...
 172 008a 27E0     		b	.L5
 173              	.L6:
  29:/home/oscar/Dokument/MOP/Pong/object.c **** 		pixel(object->geometry->points[i].x + object->pos_x, object->geometry->points[i].y + object->pos_
 ...
 225              	.LBE3:
  30:/home/oscar/Dokument/MOP/Pong/object.c **** 	}
  31:/home/oscar/Dokument/MOP/Pong/object.c **** }
 ...
 242              	move_object:
 243              	.LFB2:
  32:/home/oscar/Dokument/MOP/Pong/object.c **** 
  33:/home/oscar/Dokument/MOP/Pong/object.c **** void move_object(Object * object) {
 244              		.loc 1 33 0
 245              		.cfi_startproc
 ...
 256 00fa 7860     		str	r0, [r7, #4]
  34:/home/oscar/Dokument/MOP/Pong/object.c **** 	
  35:/home/oscar/Dokument/MOP/Pong/object.c **** 	clear_object(object);
 257              		.loc 1 35 0
 258 00fc 7B68     		ldr	r3, [r7, #4]
 259 00fe 1800     		movs	r0, r3
 260 0100 FFF7FEFF 		bl	clear_object
  36:/home/oscar/Dokument/MOP/Pong/object.c **** 	
  37:/home/oscar/Dokument/MOP/Pong/object.c **** 	object->pos_x += object->vel_x;
 261              		.loc 1 37 0
 ...
 274 011c 1A71     		strb	r2, [r3, #4]
  38:/home/oscar/Dokument/MOP/Pong/object.c **** 	object->pos_y += object->vel_y;
 275              		.loc 1 38 0
 ...
 288 0136 5A71     		strb	r2, [r3, #5]
  39:/home/oscar/Dokument/MOP/Pong/object.c **** 	
  40:/home/oscar/Dokument/MOP/Pong/object.c **** 	/* Om objektet i fråga är påväg över någon kant, skifta riktning */
  41:/home/oscar/Dokument/MOP/Pong/object.c **** 	if (!(0 <= object->pos_x && object->pos_x + object->geometry->width <= LCD_WIDTH)) {
 289              		.loc 1 41 0
 ...
 307 0158 08DD     		ble	.L9
 308              	.L8:
  42:/home/oscar/Dokument/MOP/Pong/object.c **** 		object->vel_x *= -1;
 ...
 319              	.L9:
  43:/home/oscar/Dokument/MOP/Pong/object.c **** 	}
  44:/home/oscar/Dokument/MOP/Pong/object.c **** 	
  45:/home/oscar/Dokument/MOP/Pong/object.c **** 	if (!(0 <= object->pos_y && object->pos_y + object->geometry->height <= LCD_HEIGHT)) {
 320              		.loc 1 45 0
 ...
 338 018c 08DD     		ble	.L11
 339              	.L10:
  46:/home/oscar/Dokument/MOP/Pong/object.c **** 		object->vel_y *= -1;
 ...
 350              	.L11:
  47:/home/oscar/Dokument/MOP/Pong/object.c **** 	}
  48:/home/oscar/Dokument/MOP/Pong/object.c **** 	
  49:/home/oscar/Dokument/MOP/Pong/object.c **** 	draw_object(object);
 351              		.loc 1 49 0
 352 01a0 7B68     		ldr	r3, [r7, #4]
 353 01a2 1800     		movs	r0, r3
 354 01a4 FFF7FEFF 		bl	draw_object
  50:/home/oscar/Dokument/MOP/Pong/object.c **** 	
  51:/home/oscar/Dokument/MOP/Pong/object.c **** }
 355              		.loc 1 51 0
 356 01a8 C046     		nop
 ...
 376              	set_object_vel:
 377              	.LFB3:
  52:/home/oscar/Dokument/MOP/Pong/object.c **** 
  53:/home/oscar/Dokument/MOP/Pong/object.c **** void set_object_vel(Object * object, int8_t vel_x, int8_t vel_y)
  54:/home/oscar/Dokument/MOP/Pong/object.c **** {
 378              		.loc 1 54 0
 379              		.cfi_startproc
 ...
 425              	create_ball:
 426              	.LFB4:
  58:/home/oscar/Dokument/MOP/Pong/object.c **** 
  59:/home/oscar/Dokument/MOP/Pong/object.c **** Object create_ball(int8_t pos_x, int8_t pos_y, int8_t vel_x, int8_t vel_y) {
 427              		.loc 1 59 0
 428              		.cfi_startproc
 ...
 452 0206 1A70     		strb	r2, [r3]
  60:/home/oscar/Dokument/MOP/Pong/object.c **** 	return (Object) {
 453              		.loc 1 60 0
 ...
 485 0246 5A61     		str	r2, [r3, #20]
  61:/home/oscar/Dokument/MOP/Pong/object.c **** 	&geometry_ball,
  62:/home/oscar/Dokument/MOP/Pong/object.c **** 	pos_x, pos_y,
  63:/home/oscar/Dokument/MOP/Pong/object.c **** 	vel_x, vel_y,
  64:/home/oscar/Dokument/MOP/Pong/object.c **** 	draw_object,
  65:/home/oscar/Dokument/MOP/Pong/object.c **** 	clear_object,
  66:/home/oscar/Dokument/MOP/Pong/object.c **** 	move_object,
  67:/home/oscar/Dokument/MOP/Pong/object.c **** 	set_object_vel
  68:/home/oscar/Dokument/MOP/Pong/object.c **** 	};
  69:/home/oscar/Dokument/MOP/Pong/object.c **** }
 486              		.loc 1 69 0
